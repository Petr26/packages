...
class GoogleMapsFlutterIOS extends GoogleMapsFlutterPlatform {
  ...
  Future<void> updateGroundOverlays(
    ...
    assert(
        groundOverlayUpdates.groundOverlaysToAdd.every((GroundOverlay groundOverlay) =>
  ...
  Future<void> animateCamera(
    ...
    return animateCameraWithConfiguration(cameraUpdate, const CameraUpdateAnimationConfiguration(),
        mapId: mapId);
  }
...
class HostMapMessageHandler implements MapsCallbackApi {
  ...
  void didTapOnPOI(String placeID, String name, PlatformLatLng location) {
    streamController.add(MapPoiClickEvent(
        mapId,
        PointOfInterest(
