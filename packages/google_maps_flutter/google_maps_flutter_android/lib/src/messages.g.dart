...
abstract class MapsCallbackApi {
  ...
  static void setUp(MapsCallbackApi? api, {BinaryMessenger? binaryMessenger, String messageChannelSuffix = '',}) {
    ...
    {
      final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.google_maps_flutter_android.MapsCallbackApi.onPoiClick$messageChannelSuffix', pigeonChannelCodec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        pigeonVar_channel.setMessageHandler(null);
      } else {
        pigeonVar_channel.setMessageHandler((Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.google_maps_flutter_android.MapsCallbackApi.onPoiClick was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final String? arg_placeID = (args[0] as String?);
          assert(arg_placeID != null,
              'Argument for dev.flutter.pigeon.google_maps_flutter_android.MapsCallbackApi.onPoiClick was null, expected non-null String.');
          final String? arg_name = (args[1] as String?);
          assert(arg_name != null,
              'Argument for dev.flutter.pigeon.google_maps_flutter_android.MapsCallbackApi.onPoiClick was null, expected non-null String.');
          final PlatformLatLng? arg_location = (args[2] as PlatformLatLng?);
          assert(arg_location != null,
              'Argument for dev.flutter.pigeon.google_maps_flutter_android.MapsCallbackApi.onPoiClick was null, expected non-null PlatformLatLng.');
          try {
            api.onPoiClick(arg_placeID!, arg_name!, arg_location!);
            return wrapResponse(empty: true);
          } on PlatformException catch (e) {
            return wrapResponse(error: e);
          }          catch (e) {
