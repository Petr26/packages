...
public class Messages {
  ...
  public static class MapsCallbackApi {
    ...
    public void onPoiClick(@NonNull String placeIDArg, @NonNull String nameArg, @NonNull PlatformLatLng locationArg, @NonNull VoidResult result) {
      final String channelName = "dev.flutter.pigeon.google_maps_flutter_android.MapsCallbackApi.onPoiClick" + messageChannelSuffix;
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(
              binaryMessenger, channelName, getCodec());
      channel.send(
          new ArrayList<>(Arrays.asList(placeIDArg, nameArg, locationArg)),
          channelReply -> {
            if (channelReply instanceof List) {
              List<Object> listReply = (List<Object>) channelReply;
              if (listReply.size() > 1) {
